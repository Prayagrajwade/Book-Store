...
const FavoriteBook = () => {
  return (
    ...
    <div className='md:w-1/2'>
      <h2 className='text-5xl font-bold my-5 md:w-3/4 leading-sung'>Find Your Favorite 
      <span className='text-blue-700'> Book Here!</span></h2>
      <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, 
      modi placeat reiciendis tenetur sint cum vel debitis delectus in unde quisquam,
       quidem corporis assumenda explicabo saepe.</p>
